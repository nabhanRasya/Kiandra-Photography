...
function setLoading(isLoading) {
  ...
  if (isLoading) {
    ...
    submitButton.innerHTML = `
      <svg class="animate-spin -ml-1 mr-3 h-5 w-5 bg-neutral-700 text-white hover:text-black inline-block" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
